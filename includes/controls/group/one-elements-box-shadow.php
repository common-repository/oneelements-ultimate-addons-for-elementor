...
if ( class_exists( 'Elementor\Plugin') && !class_exists( 'Group_Control_ONE_ELEMENTS_Box_Shadow') ) {
	/**
	 ...
	 * @since 1.2.2
	 */
	class Group_Control_ONE_ELEMENTS_Box_Shadow extends Group_Control_Base {
		...
		public static function get_type() {
			return 'one-elements-box-shadow';
		}
		...
		protected function init_fields() {
			...
			$controls['box_shadow'] = [
				'label'      => _x( 'Box Shadow', 'Box Shadow Control', 'one-elements' ),
			...
			$controls['box_shadow_position'] = [
				'label'       => _x( 'Position', 'Box Shadow Control', 'one-elements' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => [
					' '     => _x( 'Outline', 'Box Shadow Control', 'one-elements' ),
					'inset' => _x( 'Inset', 'Box Shadow Control', 'one-elements' ),
				],
				'default'     => ' ',
				'render_type' => 'ui',
			];
		...
		protected function get_default_options() {
			return [
				'popover' => [
					'starter_title' => _x( 'Box Shadow', 'Box Shadow Control', 'one-elements' ),
