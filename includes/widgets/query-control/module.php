<?php
namespace OneElements\Includes\Widgets\QueryControl;

use Elementor\Controls_Manager;
use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use Elementor\Widget_Base;
use OneElements\Includes\Widgets\QueryControl\Controls\Group_Control_Posts;
use OneElements\Includes\Widgets\QueryControl\Controls\Group_Control_Query;
use OneElements\Includes\Widgets\QueryControl\Controls\Group_Control_Related;
use OneElements\Includes\Widgets\QueryControl\Classes\Elementor_Post_Query;
use OneElements\Includes\Widgets\QueryControl\Classes\Elementor_Related_Query;
use OneElements\Includes\Widgets\QueryControl\Controls\Query;
...
class Module extends Module_Base {
	...
	public static function add_exclude_controls( $widget ) {
		...
		$widget->add_control(
			...
			[
				...
				'default' => '',
				'description' => __( 'Set to Yes to avoid duplicate posts from showing up on the page. This only affects the frontend.', 'one-elements' ),
			]
		);
	...
	public function ajax_posts_filter_autocomplete( array $data ) {
		...
		switch ( $data['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'one_elements/query_control/get_autocomplete/' . $data['filter_type'], [], $data );
		}
	...
	public function ajax_posts_control_value_titles( $request ) {
		...
		switch ( $request['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'one_elements/query_control/get_value_titles/' . $request['filter_type'], [], $request );
		}
	...
	/**
	 * @param \OneElements\Includes\Base\Base_Widget $widget
	 * @param string $name
