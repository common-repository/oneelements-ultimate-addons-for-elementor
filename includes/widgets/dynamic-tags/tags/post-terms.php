...
class Post_Terms extends Tag {
	...
	public function get_title() {
		return __( 'Post Terms', 'one-elements' );
	}
	...
	protected function _register_controls() {
		 ...
		 */
		$taxonomy_filter_args = apply_filters( 'one_elements/dynamic_tags/post_terms/taxonomy_args', $taxonomy_filter_args );
		...
		$this->add_control(
			'taxonomy',
			[
				'label' => __( 'Taxonomy', 'one-elements' ),
