...
class Contact_URL extends Tag {
	...
	public function get_title() {
		return __( 'Contact URL', 'one-elements' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'email' => __( 'Email', 'one-elements' ),
					'tel' => __( 'Tel', 'one-elements' ),
					'sms' => __( 'SMS', 'one-elements' ),
					'whatsapp' => __( 'WhatsApp', 'one-elements' ),
					'skype' => __( 'Skype', 'one-elements' ),
					'messenger' => __( 'Messenger', 'one-elements' ),
					'viber' => __( 'Viber', 'one-elements' ),
					'waze' => __( 'Waze', 'one-elements' ),
					'google_calendar' => __( 'Google Calendar', 'one-elements' ),
					'outlook_calendar' => __( 'Outlook Calendar', 'one-elements' ),
					'yahoo_calendar' => __( 'Yahoo Calendar', 'one-elements' ),
				],
			]
		);
		...
		$this->add_control(
			'username',
			[
				'label' => __( 'Username', 'one-elements' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => __( 'Contact', 'one-elements' ),
					'add' => __( 'Add', 'one-elements' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => __( 'Call', 'one-elements' ),
					'chat' => __( 'Chat', 'one-elements' ),
					'userinfo' => __( 'Show Profile', 'one-elements' ),
					'add' => __( 'Add to Contacts', 'one-elements' ),
					'voicemail' => __( 'Send Voice Mail', 'one-elements' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => __( 'Location', 'one-elements' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
