...
use OneElements\Includes\Widgets\QueryControl\Module as QueryModule;
...
class Internal_URL extends Data_Tag {
	...
	public function get_title() {
		return __( 'Internal URL', 'one-elements' );
	}
	...
	protected function _register_controls() {
		$this->add_control( 'type', [
			...
			'options' => [
				'post' => __( 'Content', 'one-elements' ),
				'taxonomy' => __( 'Taxonomy', 'one-elements' ),
				'attachment' => __( 'Media', 'one-elements' ),
				'author' => __( 'Author', 'one-elements' ),
			],
		] );
