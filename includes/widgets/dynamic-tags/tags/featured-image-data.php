...
class Featured_Image_Data extends Tag {
	...
	public function get_title() {
		return __( 'Featured Image Data', 'one-elements' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'attachment_data',
			[
				'label' => __( 'Data', 'one-elements' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'title',
				'options' => [
					'title' => __( 'Title', 'one-elements' ),
					'alt' => __( 'Alt', 'one-elements' ),
					'caption' => __( 'Caption', 'one-elements' ),
					'description' => __( 'Description', 'one-elements' ),
					'src' => __( 'File URL', 'one-elements' ),
					'href' => __( 'Attachment URL', 'one-elements' ),
				],
			]
		);
	}
