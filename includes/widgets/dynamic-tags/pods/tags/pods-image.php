<?php
namespace OneElements\Includes\Widgets\DynamicTags\Pods\Tags;

use Elementor\Controls_Manager;
use Elementor\Core\DynamicTags\Data_Tag;
use OneElements\Includes\Widgets\DynamicTags\Pods\Module;
...
class Pods_Image extends Data_Tag {
	...
	public function get_title() {
		return __( 'Pods', 'one-elements' ) . ' ' . __( 'Image Field', 'one-elements' );
	}
